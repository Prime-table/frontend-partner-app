...
const ProfilePage = () => {
  ...
  const handleSecondaryPhotoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  const file = e.target.files?.[0];
  if (file) {
  ...
  return (
    <div>
      ...
      <form className="profile-container" onSubmit={handleSubmit}>
        <label>
          Restaurant Name
          <input type="text" name="restaurantName" required className="tall-input" />
        </label>
          ...
          <div className="photo-upload">
            ...
            <div className="upload-container">
              ...
              <div className="drag-drop-preview">
                <p>Drag & Drop</p>
                <span className="image-preview-label">Image <br />Preview</span>
        ...
        <div className="photo-upload-small">
          ...
          <div className="upload-container">
            <div className="choose-file">
              <input type="file" accept="image/*" onChange={(e) => handleSecondaryPhotoChange(e)} />
              <span>Choose File</span>
            </div>
            <div className="drag-drop-preview">
              <p>Drag & Drop</p>
              <span className="image-preview-label">Image <br /> Preview</span>
              {secondaryPreview && <img src={secondaryPreview} alt="Preview" className="preview-img" />}
            </div>
          </div>
        </div>
